...
Function DisableServices {
    If ($LeaveServices) {
		...
		Get-Service Diagtrack,WMPNetworkSvc,irmon,SharedAccess,RpcLocator,SSDPSRV,upnphost,icssvc,XboxGipSvc,XblGameSave,XblAuthManager,XboxNetApiSvc -erroraction silentlycontinue | stop-service -passthru | set-service -startuptype disabled
